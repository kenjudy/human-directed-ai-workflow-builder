...
### Breaking Change
- **Repository split and rename**: skill formerly known as `pdca-scaffold` moved from `kenjudy/pdca-agentic-coding-framework` into its own repository `kenjudy/human-directed-ai-workflow-builder`, and renamed to `human-directed-ai-workflow-builder`. No changes to the skill content itself.
